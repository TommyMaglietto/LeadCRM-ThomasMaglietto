            ...
            <tbody>
              {display.map((scan, index) => (
                <tr
                  ...
                  style={{
                    backgroundColor:
                      index % 2 === 1 ? 'rgba(255,255,255,0.015)' : undefined,
                  }}
                >
                  {/* Trades */}
                  <td className="px-4 py-3 text-text-primary max-w-[140px]">
                    <span
                  ...
                  {/* Towns */}
                  <td className="px-4 py-3 text-text-secondary max-w-[140px]">
                    <span
                      className="block truncate"
                      title={scan.towns}
                    >
                  ...
                  <td className="px-4 py-3 text-right font-mono tabular-nums">
                    <span
                      style={{
                        color: scan.hot_count > 0 ? '#fca5a5' : '#71717a',
                      }}
                    >
                      {scan.hot_count}
                    </span>
